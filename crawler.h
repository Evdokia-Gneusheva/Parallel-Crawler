...
struct WriteFunctionData
{
    ...
    int current_level;
    bool only_local;
    std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> *checked_urls;
...
std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> extract_links(const std::string &receivedData, std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> &checked_urls, std::string root_url, bool only_local)
{
...
static size_t cb(char *data, size_t size, size_t nmemb, void *userdata)
{
    ...
    std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> links = extract_links(receivedData, *(userData->checked_urls), userData->url, userData->only_local);
...
static void init(CURLM *cm, std::string url, std::string parent, StripedHashSet<Webpage> &HashSet, std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> *checked_urls, std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> *new_urls, bool only_local, int level)
{
    ...
    curl_easy_setopt(eh, CURLOPT_SSL_VERIFYHOST, 0); // this line
    curl_easy_setopt(eh, CURLOPT_SSL_VERIFYPEER, 0); // and this line fixed the issue
...
void process_links(std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> urls, int num_urls, int max_wait, StripedHashSet<Webpage> &HashSet,
                   std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> *checked_urls, std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> *current_urls,
                   std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> *new_urls, bool only_local, int maxlevel)
{
...
void crawl_webpage(std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> urls, int num_urls, int max_wait,
    StripedHashSet<Webpage> &HashSet, bool only_local = true, int max_links_per_thread = 50, int max_level = 3, int disregard_leftovers = false)
{
    std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst> *checked_urls = new std::unordered_set<std::pair<std::string, std::string>, CompareFirst, EqualFirst>();
